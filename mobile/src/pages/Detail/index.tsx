...
const Detail = () => {
    const [{ point, items }, setData] = useState<Data>({} as Data)
    ...
    function handleWhatsapp() {
        Linking.openURL(
            `whatsapp://send?phone=${point.whatsapp}&text=Tenho interesse em coletar os resíduos do seu estabelecimento`
        )
    }
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <View style={styles.address}>
                    <Text style={styles.addressTitle}>{point.city}</Text>
